...
[ Rm, Jm, Kt, Eff_m, Km, Kg, Eff_g, Mc, r_mp, Beq ] = setup_ip01_2_configuration( CART_TYPE, IP02_LOAD_TYPE, AMP_TYPE );
...
[ An, Bn ] = d_ip01_2_actuator_dynamics( A, B, AMP_TYPE, Rm, Kt, Eff_m, Km, Kg, Eff_g, Mc, r_mp );
%
if strcmp ( CONTROLLER_TYPE, 'LQR_AUTO' )
    ...
    % Automatically calculate the LQR controller gain using actuator
    % dependent state-space matrices.
    [ K ] = d_ip01_2_sip_lqr( An, Bn, C, D, Q, R );
